(module
  ...
  (import "env" "___syscall3" (func $env.__syscall3 (type $t2)))
  (import "env" "___syscall1" (func $env.__syscall1 (type $t3)))
  (import "env" "___syscall5" (func $env.__syscall5 (type $t4)))
  (func $main (export "main") (type $t5) (result i32)
    i32.const 1024
    call $f11
    drop
    i32.const 0)
  (func $writev_c (export "writev_c") (type $t0) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    ...
    i32.const 0)
  (func $f6 (type $t6) (param $p0 i32) (result i32)
  ...
  (func $f8 (type $t6) (param $p0 i32) (result i32)
    (local $l0 i32)
    get_local $p0
    get_local $p0
    ...
    i32.store
    i32.const -1)
  (func $f9 (type $t2) (param $p0 i32) (param $p1 i32) (param $p2 i32) (param $p3 i32) (result i32)
    ...
    get_local $p1
    i32.div_u)
  (func $f10 (type $t3) (param $p0 i32) (param $p1 i32) (result i32)
    ...
    set_global $g0
    get_local $l0)
  (func $f11 (type $t6) (param $p0 i32) (result i32)
    (local $l0 i32) (local $l1 i32) (local $l2 i32)
    i32.const 1036
    i32.load
    tee_local $l0
  ...
  (func $f12 (type $t6) (param $p0 i32) (result i32)
    ...
    get_local $p0)
  (func $f13 (type $t6) (param $p0 i32) (result i32)
    i32.const 6
    get_local $p0
    i32.load offset=60
    call $env.__syscall1
  ...
  (func $f15 (type $t0) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    ...
    set_global $g0
    get_local $p0)
  (func $f16 (type $t7) (param $p0 i32) (param $p1 i64) (param $p2 i32) (result i64)
    (local $l0 i32)
    get_global $g0
    i32.const 16
    i32.sub
  ...
  (func $f17 (type $t0) (param $p0 i32) (param $p1 i32) (param $p2 i32) (result i32)
    ...
    get_local $p0)
  (func $f18 (type $t6) (param $p0 i32) (result i32)
    (local $l0 i32) (local $l1 i32) (local $l2 i32)
    block $B0
      block $B1
        block $B2
  ...
  (elem (i32.const 1) $f14 $f13 $f15 $f16)
